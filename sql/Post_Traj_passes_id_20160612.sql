...
CREATE OR REPLACE FUNCTION Post_Traj_passes_3d_id(trajectory, geometry) RETURNS boolean AS
$$
DECLARE
...
BEGIN		
	...
	IF session_value = '0' THEN
		...
		sql_text := sql_text || ' WHERE tpArr_to_geom(mp.rect) &&& $1 AND TJ_Passes(mp.tpseg, $1)';
