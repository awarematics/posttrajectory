...
#define PGSQL_LOCALEDIR "/usr/local/pgsql/share/locale"

/* Enable caching of bounding box within geometries */
#define POSTGIS_AUTOCACHE_BBOX 1

/* PostGIS build date */
#define POSTGIS_BUILD_DATE "2016-06-05 17:20:10"
...
#define POSTGIS_MINOR_VERSION "2"
...
#define POSTGIS_RASTER_BUILD_DATE "2016-06-05 17:20:10"
...
#define POSTGIS_SCRIPTS_VERSION "2.2.2"

/* Enable use of ANALYZE statistics */
#define POSTGIS_USE_STATS 1

/* PostGIS version */
#define POSTGIS_VERSION "2.2 USE_GEOS=1 USE_PROJ=1 USE_STATS=1"
